...
User changePassword(User u){
    ...
    {
       newp:
       cout << "\n\t\tEnter your new password [4 characters]: ";
       ...
       if(length(new_pass) != 4){
          ...
          set_color(h, 12);
          cout << "\n\t\tYour password must contain <4 characters>\n";
          set_color(h, 15);
          goto newp;
       }
       confp:
       cout << "\n\t\tConfirm your new password [4 characters]: ";
       ...
       cout << "\n\t\tThis is your account number :(\a\n";
        ...
        if(is_exist(temp_u, 0))
        {
            ...
            if(amount > u.balance){
              ...
              temp_u = getUser(temp_u, 0);
              u.balance -= amount, temp_u.balance += amount;
              updateUser(u), updateUser(temp_u);
              set_color(h, 10);
  ...
  color_text("0. Logout", 8); cout << "\n\n\t\tEnter: ";
    ...
    case 3:
		...
		case 5:
      {
        ...
        u = getUser(u, 1);  // to update user balance for the next call
			  Switch_User_Options(u);
        break;
      }
		default:
