...
void Switch_Admin_Options(Admin a){
    ...
    Welcome_Admin(a);
	  ll opt, id;
	  User temp;
    if(!strcmp(a.reason, "refused")){
       set_color(h, 6);
       cout << "\n\t\tThe manager refused your resignation request :(\n";
       Press_any_key();
       memset(a.reason, '\0', sizeof(a.reason));
       updateAdmin(a);
